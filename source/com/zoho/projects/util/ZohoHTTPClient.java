...
public class ZohoHTTPClient {
	...
	public static String post(String url, HashMap<String, Object> requestBody) throws Exception {
		...
		StringBuilder requestParams = new StringBuilder(100);

		try(DataOutputStream dos = new DataOutputStream(httpPost.getOutputStream())) {
			if(requestBody != null)	{
	...
	public static String put(String url, HashMap<String, Object> requestBody) throws Exception {
		...
		try(DataOutputStream dos = new DataOutputStream(httpPut.getOutputStream())) {
